...
public static int Choice(){
 ...
 System.out.println("A.       Candy         [10]");
 System.out.println("B.       Chips         [15]");
 System.out.println("C.       Poptart       [10]");
 System.out.println("D.       CloudNine     [20]");
 System.out.println("E.       Drinks        [25]");
...
public static void main(String[] args){
  System.out.println("WELCOME TO CORREA'S CANDY MACHINE");
